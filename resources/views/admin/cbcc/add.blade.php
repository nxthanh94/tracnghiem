      ...
      <div class="col-md-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left" novalidate action="{{ route('admin.cbcc.add') }}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
                  ...
                  <div class="x_title">
                    <div class="item form-group">
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="name" placeholder="Vui lòng nhập thông tin" required="required" type="text" maxlength="255">
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="control-label col-md-2 col-sm-2 col-xs-12">Mã đơn vị</label>
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="madonvi" placeholder="Vui lòng nhập thông tin" required="required" type="text" maxlength="255">
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="control-label col-md-2 col-sm-2 col-xs-12">Tên đơn vị</label>
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="donvi" placeholder="Vui lòng nhập thông tin" required="required" type="text" maxlength="255">
                      </div>
                    </div>
