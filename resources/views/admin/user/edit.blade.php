                  ...
                  <div class="x_title">
                    <div class="item form-group">
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="username" placeholder="Vui lòng nhập thông tin" required="required" type="text" value="{{ $username }}">
                      </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input type="tel" id="telephone" name="phone" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12" placeholder="Vui lòng nhập thông tin" value="{{ $phone }}">
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="control-label col-md-2 col-sm-2 col-xs-12">Địa chỉ</label>
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="diachi" placeholder="Vui lòng nhập thông tin" required="required" type="text" value="{{ $diachi }}">
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="control-label col-md-2 col-sm-2 col-xs-12" for="textarea">Giới thiệu</label>
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <textarea id="textarea" required="required" name="mota" class="form-control col-md-7 col-xs-12">{!! $mota !!}</textarea>
                      </div>
                    </div>
                  </div>
                </div>
